-- -------------------------------------------------------------
-- 
-- File Name: D:\qq\li\hdl_coder\lms2.0\codegen\mlhdlc_lms_fcn\hdlsrc\mlhdlc_lms_fcn_fixpt.vhd
...
ARCHITECTURE rtl OF mlhdlc_lms_fcn_fixpt IS
  ...
  -- Signals
  SIGNAL tmp                              : vector_of_signed16(0 TO 39);  -- sfix16 [40]
  SIGNAL u_d                              : vector_of_signed16(0 TO 39);  -- sfix16 [40]
  SIGNAL vt                               : vector_of_signed16(0 TO 1);  -- sfix16 [2]
  SIGNAL vt_1                             : vector_of_signed16(0 TO 2);  -- sfix16 [3]
  SIGNAL tmp_1                            : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL vt_2                             : vector_of_signed16(0 TO 4);  -- sfix16 [5]
  SIGNAL vt_3                             : vector_of_signed16(0 TO 2);  -- sfix16 [3]
  SIGNAL p3vt_cast                        : vector_of_signed64(0 TO 2);  -- sfix64 [3]
  SIGNAL vt_4                             : vector_of_signed16(0 TO 9);  -- sfix16 [10]
  SIGNAL vt_5                             : vector_of_signed16(0 TO 4);  -- sfix16 [5]
  SIGNAL p6vt_cast                        : vector_of_signed64(0 TO 4);  -- sfix64 [5]
  SIGNAL vt_6                             : vector_of_signed16(0 TO 19);  -- sfix16 [20]
  SIGNAL vt_7                             : vector_of_signed16(0 TO 9);  -- sfix16 [10]
  SIGNAL p9vt_cast                        : vector_of_signed64(0 TO 9);  -- sfix64 [10]
  SIGNAL weight_applied                   : vector_of_signed16(0 TO 39);  -- sfix16 [40]
  SIGNAL vt_8                             : vector_of_signed16(0 TO 19);  -- sfix16 [20]
  SIGNAL p12vt_cast                       : vector_of_signed64(0 TO 19);  -- sfix64 [20]
  SIGNAL filtered_signal_1                : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL esig                             : signed(15 DOWNTO 0);  -- sfix16_En1
  SIGNAL p28esig_sub_temp                 : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL step_sig                         : signed(15 DOWNTO 0);  -- sfix16_En31
  SIGNAL p30step_sig_mul_temp             : signed(32 DOWNTO 0);  -- sfix33_En46
  SIGNAL p30step_sig_cast                 : signed(31 DOWNTO 0);  -- sfix32_En46
  SIGNAL correction_factor                : vector_of_signed16(0 TO 39);  -- sfix16_En17 [40]
  SIGNAL p31correction_factor_mul_temp    : vector_of_signed32(0 TO 39);  -- sfix32_En31 [40]
  ...
  SIGNAL p33updated_weight_add_cast       : vector_of_signed20(0 TO 39);  -- sfix20_En17 [40]
  SIGNAL p33updated_weight_add_cast_1     : vector_of_signed20(0 TO 39);  -- sfix20_En17 [40]
  SIGNAL p33updated_weight_add_temp       : vector_of_signed20(0 TO 39);  -- sfix20_En17 [40]
  SIGNAL p13weight_applied_mul_temp       : vector_of_signed32(0 TO 39);  -- sfix32_En14 [40]
  SIGNAL p18vt_cast                       : vector_of_signed64(0 TO 1);  -- sfix64 [2]
  SIGNAL vt_13                            : vector_of_signed16(0 TO 1);  -- sfix16 [2]
  SIGNAL vt_14                            : signed(15 DOWNTO 0);  -- sfix16
  SIGNAL vt_15                            : signed(15 DOWNTO 0);  -- sfix16

BEGIN
  -- update filter coefficients register
  u_d_reg_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        u_d <= (OTHERS => to_signed(16#0000#, 16));
      ELSE 
        u_d <= tmp;
      END IF;
    END IF;
  ...
  vt_5_gen: FOR t_01 IN 0 TO 4 GENERATE
    ...
    vt_5(t_01) <= vt_4(to_integer(resize(p6vt_cast(t_01), 31)));
  ...
  p28esig_sub_temp <= resize(desired, 17) - resize(filtered_signal_1, 17);
  esig <= p28esig_sub_temp(14 DOWNTO 0) & '0';
  ...
  correction_factor_gen: FOR t_04 IN 0 TO 39 GENERATE
    ...
    correction_factor(t_04) <= p31correction_factor_mul_temp(t_04)(29 DOWNTO 14);
  END GENERATE correction_factor_gen;



  updated_weight_gen: FOR t_05 IN 0 TO 39 GENERATE
    p33updated_weight_add_cast(t_05) <= resize(correction_factor(t_05), 20);
    p33updated_weight_add_cast_1(t_05) <= resize(filter_coeff(t_05) & '0' & '0' & '0', 20);
    p33updated_weight_add_temp(t_05) <= p33updated_weight_add_cast(t_05) + p33updated_weight_add_cast_1(t_05);
    updated_weight(t_05) <= p33updated_weight_add_temp(t_05)(18 DOWNTO 3);
  END GENERATE updated_weight_gen;


  filter_coeff_reg_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
  ...
  weight_applied_gen: FOR t_06 IN 0 TO 39 GENERATE
    ...
    weight_applied(t_06) <= p13weight_applied_mul_temp(t_06)(29 DOWNTO 14);
  ...
  BEGIN
    ...
    FOR i2 IN 0 TO 4 LOOP
      ...
      vt11(i2) := vt11(i2) + vt_4(to_integer(sub_cast_12(i2) - 1));
    END LOOP;
  ...
  y <= resize(esig(15 DOWNTO 1), 16);

  filtered_signal_1 <= vt_15;
