					...
					//------------------------------------蜂鸣器测试-------------------------------
						if(beep_cnt==1000000&&beep_flag==1)
						{
								...
								switch(beep_switch){
									...
									default:beep_switch = 0;stop_flag = 1;beep_flag = 0;moku_flag = 0;Beep0 = 0;Beep1 = 0;Beep2 = 0;Beep3 = 0;Beep4 = 0;Beep5 = 0;break;
								}
								beep_switch++;
						}
//					}
			...
			//---------------------------------结束后返回初始值----------------------------			
					...
					if (USART_RX_STA & 0x8000)
					{
							...
							switch(line_cnt)
							{
								...
								case 'V':Draw_PID_flag=1;printf("page PID_wave\xff\xff\xff");break;
								case 'W':Draw_PID_flag=0;printf("page wave\xff\xff\xff");break;
								case '0':flag = '0';stop_flag=0;moku_flag = 0;
