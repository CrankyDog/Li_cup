...
# ACDS 17.1 590 win32 2022.04.02.19:53:46
# ----------------------------------------
...
# ----------------------------------------
# If fir_all is one of several IP cores in your
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "D:/qq/quartus_17_1/quartus/"
}
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/fir_all_rtl_core_u0_m0_wo0_cm0_lutmem.hex ./
  file copy -force $QSYS_SIMDIR/fir_all_rtl_core_u0_m0_wo0_wi0_r0_ra0_count1_lut_lutmem.hex ./
}
...
alias com {
  ...
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/fir_all_rtl_core.vhd"                           
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/fir_all_ast.vhd"                                
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/fir_all.vhd"                                    
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS          "$QSYS_SIMDIR/fir_all_tb.vhd"                                 
}
