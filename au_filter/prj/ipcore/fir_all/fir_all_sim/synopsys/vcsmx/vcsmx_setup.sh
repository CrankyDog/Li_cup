...
TOP_LEVEL_NAME="fir_all"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="D:/qq/quartus_17_1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/fir_all_rtl_core_u0_m0_wo0_cm0_lutmem.hex ./
  cp -f $QSYS_SIMDIR/fir_all_rtl_core_u0_m0_wo0_wi0_r0_ra0_count1_lut_lutmem.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/fir_all_rtl_core.vhd"                           
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/fir_all_ast.vhd"                                
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/fir_all.vhd"                                    
  vhdlan -xlrm $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/fir_all_tb.vhd"                                 
fi
